...
example = dataset["train"][5]["problem"]  # test on a single input
messages = [
...
prompt_string = tokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=True, return_tensors="pt")
